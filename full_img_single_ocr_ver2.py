...
# === merged_output.png oluşturan ana işlem ===
def process_bulk_image(image_path):
...
if __name__ == "__main__":
    start_time = time.time()
    # merged_output.png den OCR la alınan veriyi excel e yazan kısmın başlangıcı
    process_rows()
    process_image("merged_output.png")
    process_bulk_image("merged_output.png")
    end_time = time.time()
